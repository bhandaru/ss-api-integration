...
#for i in range(1):
    ...
    export_file = "./AsanaData/Out/Tech/"+x['name'].replace('/','-') + ".xlsx" #"Eco Co-creation Projects"
    ...
    worksheet.write("L"+str(2), (x['assignee']['name'] if x['assignee'] != None else ''),cf)
    ...
    for j in range(len(x['subtasks'])):
        ...
        worksheet.write("K"+str(row_num), (y['assignee']['name'] if y['assignee'] != None else ''),cf)
        worksheet.write("L"+str(row_num), '',cf)
